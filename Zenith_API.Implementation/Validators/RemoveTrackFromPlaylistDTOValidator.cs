...
{
    public class RemoveTrackFromPlaylistDTOValidator : AbstractValidator<TrackToPlaylistDTO>
    {
        public RemoveTrackFromPlaylistDTOValidator(ZenithContext context)
        {
            ...
            RuleFor(x => x.TrackId)
                ...
                .Must((dto, trackId) => context.PlaylistTracks.Any(pt => pt.TrackId == trackId && pt.PlaylistId == dto.PlaylistId))
                .WithMessage("Track doesn't exist in this playlist.");
